...
namespace UIHelpers
{
	static void CreateFonts(HFONT& hFontTitle, HFONT& hFontButton, HFONT& hFontStatus, HFONT& hFontFooter)
	{
	...
	static HBITMAP LoadBitmapResource(InjectorContext& ctx)
	{
	...
	static void CreateImageControl(HWND hwnd, HBITMAP hBitmap)
	{
	...
	static void CreateTitleControl(HWND hwnd, HFONT hFontTitle)
	{
	...
	static void CreateProcessControls(InjectorContext& ctx, HWND hwnd, HFONT hFontStatus, HFONT hFontButton)
	{
	...
	static void CreateDLLControls(InjectorContext& ctx, HWND hwnd, HFONT hFontStatus, HFONT hFontButton)
	{
	...
	static void CreateProgressBar(InjectorContext& ctx, HWND hwnd)
	{
	...
	static void CreateStatusControl(InjectorContext& ctx, HWND hwnd, HFONT hFontStatus)
	{
	...
	static void CreateFooterControl(HWND hwnd, HFONT hFontFooter)
	{
	...
	static void PopulateProcessList(InjectorContext& ctx)
	{
	...
	static void RestoreLastSelection(InjectorContext& ctx)
	{
...
{
	static void HandleRefresh(InjectorContext& ctx)
	{
	...
	static void HandleProcessSelection(InjectorContext& ctx)
	{
	...
	static void HandleBrowseDLL(InjectorContext& ctx, HWND hwnd)
	{
		OPENFILENAMEW ofn		  = { 0 };
	...
	static bool ValidateInjectionPreconditions(InjectorContext& ctx, HWND hwnd)
	{
	...
	static bool ConfirmInjection(InjectorContext& ctx, HWND hwnd)
	{
	...
	static DWORD FindTargetProcess(InjectorContext& ctx)
	{
	...
	static void EnableDebugPrivileges(InjectorContext& ctx)
	{
		HandleGuard hToken;
	...
	static HANDLE OpenTargetProcess(InjectorContext& ctx, DWORD pid)
	{
	...
	static bool VerifyArchitecture(InjectorContext& ctx, const HandleGuard& hProcess)
	{
	...
	static std::vector<BYTE> LoadDLLData(InjectorContext& ctx)
	{
