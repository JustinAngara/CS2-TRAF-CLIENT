...
public:
	...
	void adjust_input_history(CCSGOInputHistoryEntryPB* tick, const QAngle_t& angView, int t, int target_idx, Vector eyepos, int tickbase)
	{
		if (!tick)
		{
			return;
